...
## 📂 Contents (of the ufcDataAnalysis.xlsx file)
### 1. Main Dataset
...
### 2. Fights & Events Overview
Pivot tables and charts showing number of fights and events per year, fight volume by weight class.

### 3. Title vs. Non-Title Trends
Tables and charts for title fights by year, non-title fights by year, and both categories broken down by weight class.

### 4. Performance Metrics vs. Win Rate
Analysis of significant strike differential, takedown differential, and submission attempt differential and their correlation with win rates.

### 5. Attribute Advantages
Height, reach, and age differences compared against win rate.

### 6. Submission Analysis
Charts showing submission wins vs. submission attempts, along with the popularity of each submission type.
